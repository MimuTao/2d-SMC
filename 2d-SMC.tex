...
\section{Introduction}
	 On the other hand, two-dimensional (2D) systems have be used to describe a wide variety of practical applications, such as digital image processing, partial differential equations modeling and signal filtering \cite{roesser}-\cite{signal-processing}, etc. Comparied with one dimensional (1D) systems, the key feature of  2D systems is that thay are consist of two independent  information that propagated along different directions.
